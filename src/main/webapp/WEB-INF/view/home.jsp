          ...
          <div class="masthead clearfix">
            <div class="inner">
              ...
              <security:authorize access="isAnonymous()">
                <a class="nav-link active" href="${pageContext.request.contextPath}/main/?page=1">Login</a>
                <a class="nav-link" href="${pageContext.request.contextPath}/register/showRegistrationForm">Register</a>
               </security:authorize>
               <security:authorize access="hasRole('USER')">
               <a class="nav-link" href="${pageContext.request.contextPath}/logout">Logout</a>
               <a class="nav-link" href="${pageContext.request.contextPath}/main/?page=1">Code Repository</a>
               </security:authorize>
