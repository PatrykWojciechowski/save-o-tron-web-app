      ...
      <div class="site-wrapper-inner">
        <div class="cover-container">
		  ...
		  <div class=jumbotron>
				...
				I would like to change the path of my career and become a Java developer in the future.
				I also believe that working with projects like this web application will help me develop variety of skills. <br>
